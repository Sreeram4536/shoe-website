...
<div class="banner_top innerpage" id="home">
				...
				<div class="deal-leftmk left-side">
					...
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							...
							<a href="single.html">INR 180.00</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							...
							<a href="single.html">INR 99.00</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							<h3>Bella Toes</h3>
							<a href="single.html">INR 165.00</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							<h3>Red Bellies</h3>
							<a href="single.html">INR 225.00</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							<h3>(SRV) Sneakers</h3>
							<a href="single.html">INR 169.00</a>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
                                        ...
                                        <div class="men-thumb-item">
                                            ...
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="/product/<%= product._id %>" class="link-product-add-cart">Quick View</a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="grid_meta">
                                                    <div class="product_price">
                                                        <div class="grid-price">
                                                            ...
                                                            <span class="money">INR<%= product.salePrice %></span>
                                                        </div>
                                                    </div>
                    
                                                    <!-- Star ratings can be dynamically rendered if you have a rating field -->
                                                    <!-- <ul class="stars">
                                                        </*%for(let i = 1; i <= 5; i++) { %>
                                                            <li>
                                                                <a href="#">
                                                                    <i class="fa </*%= i <= product.rating ? 'fa-star' : 'fa-star-o' %>" aria-hidden="true"></i>
                                                                </a>
                                                            </li>
                                                        </*% } %>  
                                                    </ul>   -->
	...
	<div class="footer_agileinfo_w3">
		<div class="footer_inner_info_w3ls_agileits">
			...
			<p class="copy-right-w3ls-agileits">&copy 2018 Downy Shoes. All rights reserved</p>
		</div>
	</div>
	</div>
	<!-- //footer -->
